...
# df_des['return_words'] = df_des['description'].apply(return_keyword, key_words=key_words)
# df_des['return_words_no_accent'] = df_des['description_no_accent'].apply(return_keyword, key_words=key_words_no_accent)
